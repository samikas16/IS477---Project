...
The EPA air quality dataset contained 501 city-level observations across the United States for 2024. The median AQI across all cities ranged from 3 to 97, with a mean of 41 and a standard deviation of 11, indicating that most cities maintained relatively moderate air quality throughout the year. On average, cities experienced 237 good air quality days out of the year, meaning the majority of days in most cities had satisfactory air quality. The maximum single-day AQI recorded across all cities was 1,513, which is well above the hazardous threshold and likely reflects a severe wildfire or pollution event.

The FBI crime dataset contained 8,986 city-level observations across the United States for 2024. The violent crime rate ranged from 0 to 50,000 per 100,000 residents, with a mean of 249 and a median of 148, suggesting that most cities have relatively low violent crime rates, but a small number of cities pull the average upward significantly. The property crime rate ranged from 0 to 1,375,000 per 100,000 residents, with a mean of 1,664 and a median of 1,002.

We found that after merging the EPA air quality dataset with the FBI crime dataset, we retained 463 city-level observations across the United States for 2024. The merged dataset covers cities with a median AQI ranging from 7 to 97, a mean violent crime rate of 490 per 100,000 residents, and a mean property crime rate of 2,379 per 100,000 residents.

The cities were then divided into four quartile groups based on Median AQI. Cities in the best air quality quartile (Q1) had an average violent crime rate of 389 per 100,000 and an average property crime rate of 2,163 per 100,000. Cities in Q2 had an average violent crime rate of 406 and property crime rate of 2,131 per 100,000. Cities in Q3 had an average violent crime rate of 525 and property crime rate of 2,425 per 100,000. In contrast, cities in the worst air quality quartile (Q4) had an average violent crime rate of 648 per 100,000 and an average property crime rate of 2,824 per 100,000. This represents a 66% increase in violent crime and a 31% increase in property crime between the cleanest and most polluted city groups. As shown in the bar chart, both violent and property crime rates rise steadily from Q1 through Q4, with property crime rates consistently far exceeding violent crime rates across all quartiles.

The five cities with the highest median AQI were Riverside-San Bernardino, CA (97), Phoenix-Mesa-Scottsdale, AZ (86), Bakersfield, CA (72), Visalia-Porterville, CA (71), and San Diego, CA (71). These cities are all located in California or Arizona. Their violent crime rates varied considerably — Phoenix had the highest at 797 per 100,000, while San Diego had the lowest at 412 per 100,000 — and all five had above-average property crime rates relative to the full dataset mean of 2,379.

The five cities with the highest violent crime rates were Memphis, TN (2,489 per 100,000), Detroit, MI (1,781), Atlantic City, NJ (1,780), Little Rock, AR (1,672), and Americus, GA (1,654). Notably, these high-crime cities did not necessarily have the worst air quality, suggesting that crime is influenced by many factors beyond pollution alone. This is also visible in the scatter plots, where both violent and property crime rates show wide vertical spread across all AQI values, indicating no strong linear relationship between air quality and crime.

The boxplot of good air quality days by AQI quartile shows a clear downward trend: cities in Q1 had a median of roughly 305 good days per year, Q2 approximately 270, Q3 approximately 235, and Q4 approximately 165. This confirms that the quartile groupings are internally consistent and that cities with worse air quality experience significantly fewer clean air days annually. Cities in the low crime group averaged 239 good air quality days per year, compared to 208 for mid crime cities and 164 for high crime cities, further supporting the association between cleaner air and lower crime, though this likely reflects shared underlying socioeconomic conditions rather than a direct causal relationship.

Overall, the data shows a general trend where cities with worse air quality tend to have higher crime rates. However, the relationship is not perfectly consistent across all cities, and many high-crime cities have moderate air quality, suggesting that factors such as poverty, population density, and urban development likely drive both outcomes simultaneously.
